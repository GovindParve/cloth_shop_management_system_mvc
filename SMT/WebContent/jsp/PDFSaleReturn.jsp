...
try
{
	...
	ResultSet rs = stmt.executeQuery("select sr.ItemName, sr.BarcodeNo, sr.ReturnQuantuty, sr.SalePrice, sr.BillNo, sr.Customer_Name, sr.BillReturnDate, sr.Discount, sr.taxAmount, sr.gst, sr.iGst, sr.total_amount_per_item, sr.Return_Total, sb.subcat_name from salereturn sr JOIN sub_categories sb on sr.subCatId = sb.pk_subcat_id where sr.transactionId = "+transactionIdSr);
	...
	headerTable_cell21 = new PdfPCell(new Phrase("STYLEME", font10Bold));
	...
	headerTable_cell21 = new PdfPCell(new Phrase("Baramati", font10));
	headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
	headerTable_cell21.setPaddingBottom(2);
	headerTable_cell21.setBorder(Rectangle.NO_BORDER);
	headertable21.addCell(headerTable_cell21);
	...
	headerTable_cell21 = new PdfPCell(new Phrase("Bill No: "+billno,font8Bold));
	headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
	headerTable_cell21.setPaddingTop(8);
	headerTable_cell21.setBorder(Rectangle.NO_BORDER);
	headertable21.addCell(headerTable_cell21);
...
double totalAmountPerItem = rs.getDouble("total_amount_per_item");

//finalTotAmountWithoutDis = finalTotAmountWithoutDis + totalPerItem;
finalTotAmountWithoutDis = totalPerItem;
table_cell = new PdfPCell(new Phrase(""+totalAmountPerItem, font10));
table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
table_cell.setBorder(Rectangle.LEFT | Rectangle.RIGHT);
table.addCell(table_cell);

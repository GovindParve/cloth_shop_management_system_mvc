<!-- TaxInvoiceHoldBillEditAndPrint.jsp -->
...
<%-- 				<input type="hidden" readonly="readonly" id="billNo" name="billNo" value=<%=BillNo%>> --%>
			...
			<div align="center" id="saleinvceh2">
				<span class="form-name style_heading">Tax Invoice Hold Bill Edit And Print</span>
			</div>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"
							...
							<label for="totalQuantity">Total Quantity<sup>*</sup></label> -->
							 ...
							 <input type="text" id="billNoBW" autofocus="autofocus" onchange="getEmpName(); getSaleInvoceBillNonGridDetailsByBillNoForTaxInvoiceHoldBillEditAndPrintBilling(); getSaleInvoceBillGridDetailsAndNewItemInGridByBillNoOrBarcodeNoOrItemDetailsForTaxInvoiceHoldBillEditAndPrintBillingValidation()" required/>
					...
					<div class="row">
						<div class="invoice_label_up">
							<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4" id="taxcol">
								...
								<input type="text" id="key" autofocus="key" onchange="getEmpName(); getSaleInvoceBillGridDetailsAndNewItemInGridByBillNoOrBarcodeNoOrItemDetailsForTaxInvoiceHoldBillEditAndPrintBillingValidation()" required />
				...
				<div class="invoice_label_up">
					<div class="good_rcv_label_up">
						...
						<!-- <div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"> -->
							...
							<input list="itemId_drop" id="itemName" class="" onchange="getEmpName(); getSaleInvoceBillGridDetailsAndNewItemInGridByBillNoOrBarcodeNoOrItemDetailsForTaxInvoiceHoldBillEditAndPrintBillingValidation()" required>
					...
					<div class="invoice_button">
							...
							<!-- <div class="col-md-2" style="display: inline-block;"> -->
								<input type='button'
									...
									value="Print Bill" onclick="taxInvoiceHoldBillEditAndPrintBillingSaveValidation();">
							<!-- </div> -->
							...
							<!-- </div> -->
 							...
 							<!-- <div class="col-md-2" style="display: inline-block;"> -->
								<!-- <input type='button' class="btn btn-success btn-lg bottomButtons btnwidth" id="btnSubmit1"

                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <input type="text" id="saleAmount" readonly="readonly" style="display:none;" >
                    </div>
                    <div class="">
                     <!--  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Sales(Daily)(Credit)</div> -->
                    <i class="fas fa-dollar-sign fa-2x text-gray-300 icon-style"></i>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <input type="text" id="saleAmountReg" readonly="readonly" style="display:none" >
                    </div>
                    <!-- <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div> -->
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <input type="text" id="purchaseid" readonly="readonly">
                    </div>
                    <div class="col-auto">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     ...
                     <div class="row no-gutters align-items-center">
                       ...
                       <input type="text" id="yestid" readonly="readonly" style="display:none" >
                        </div>                                         
                     </div>
                    </div>
                     <!-- 
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <input type="text" id="saleAmountReg1" readonly="readonly" style="display:none" >
                    </div>
                    <!-- <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div> -->
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <input type="text" id="purchaseid1" readonly="readonly">
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>

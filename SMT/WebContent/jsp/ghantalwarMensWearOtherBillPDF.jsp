...
<%
	...
	String CustGst = (String) session.getAttribute("custGst");
	...
	try
	{
		...
		float[] HeadercolumnWidths21 = { 1.0f, 1.5f, 1.0f };
		...
		CustGst = rs.getString("CustGst");
		headerTable_cell21 = new PdfPCell(new Phrase("Customer Gst: " + rs.getString("CustGst"), font8));
		headerTable_cell21.setBorder(Rectangle.NO_BORDER);
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_CENTER);
		headertable21.addCell(headerTable_cell21);

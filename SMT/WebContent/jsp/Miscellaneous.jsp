...
<%@page import="com.smt.hibernate.BillNumberGenratorHibernate"%>
...
<%
	...
	System.out.println("Month in MMMM format New :- "+date);*/
%>
<%
	/*String Hr;
	...
	//String BillNo = month+"/"+year+"/" + "00" +"1";
	String BillNo = year+"/"+month+"/" + "00" +"1";
	System.out.println(" JSP 01 Bill No :- "+BillNo);*/
%>
<%
	/*OtherBillDao RBDao = new OtherBillDao();
	List bill = RBDao.getResourceLastBillNo();
	
	for(int i=0;i<bill.size();i++)
	{
		BillBean bean = (BillBean)bill.get(i);
		Hr = bean.getBillNo();	//Jun/2020/22
		String[] HrBil = Hr.split("/");
		
		String lNo = HrBil[2];
		
		Long lstNo = Long.parseLong(lNo);
		Long LastNo = lstNo + 1;
		
		String LastNoString = String.valueOf(LastNo) ;
		
		//BillNo = month+"/"+year+"/" + "00" +LastNo;
		BillNo = year+"/"+month+"/" +LastNo;
		//BillNo = year+""+month+"" + "00" +LastNo;
		
		System.out.println(" JSP 02 Bill No :- "+BillNo);
	...
	OtherBillDao data = new OtherBillDao();
	billNumberGenratorHibernate = data.getBillNumberGenratorDetails();
...
<body class="purchase_form_img vColor" onload="getEmpName();">
	<div class="container-fluid">
		...
		<!-- <div class="row"> -->
		<div id="billheading" style="padding-top: 20px; padding-right: 150px" align="right">
			<!-- <div class="vouch"> -->
			...
			<div align="center" id="saleinvceh2">
				<span class="form-name style_heading">Tax Invoice</span>
			</div>
						...
						<div class="invoice_label_up">
							<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4" id="taxcol">
								<input type="text" id="key" autofocus="key"
									onchange="getEmpName(),getitemData1New();"
				...
				<div class="invoice_label_up">
					<div class="good_rcv_label_up">
						...
						<!-- <div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4"> -->
							...
							<input list="itemId_drop" id="itemName" class="" onchange="getEmpName(), getitemData1New();" required> <!-- style="background-color: #f0f0f0" -->
				  ...
				  <div class="col-md-1"></div>
					...
					<div class="invoice_button">
							...
							<!-- <div class="col-md-2" style="display: inline-block;"> -->
								<input type='button' class="btn btn-success btn-lg bottomButtons btnwidth" id="btnSubmit"
								...
								<div class="row">
									<div class="invoice_label_up">
										<div
											class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4 col-lg-offset-1"
											id="cashcol">
											<input type="text" name="cashCard_cardAmount1"

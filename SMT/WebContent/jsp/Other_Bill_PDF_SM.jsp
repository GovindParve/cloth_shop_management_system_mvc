...
<%
	...
	try
	{
		...
		float[] HeadercolumnWidths21 = { 0.9f };
		...
		headerTable_cell21.setPaddingRight(25);
...
if (a<6)
{
	...
	//SalePrice
	Double SalePrice = Double.valueOf(rs.getDouble("SalePrice"));
	//String SalePrice = String.valueOf(saletotal);
	//String totalWeight = String.valueOf(saletotal);
	//table_cell = new PdfPCell(new Phrase("Sale Price:- " + totalWeight));

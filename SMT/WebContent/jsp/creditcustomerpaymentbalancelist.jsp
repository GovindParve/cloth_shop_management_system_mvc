	...
	<div class="container" id="reportheight">
		...
		<div class="row">
			<div align="center" id="prolossheading">
				<h2 class="form-name style_heading">Credit Customer Balance Report</h2>
			</div>
		</div>
		...
		<form action="cashAmount" method="post" class="form-horizontal">
				...
				<div class="invoice_label_up">
					 <div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-4" id="profitreport">
						...
						<div class="invoice_button">
							<input type="button" id="btn" name="save" onclick="getCreditCustomerBalanceReportNameWise()" value="Search" 
			...
			<div class="row mb-50" align="center">
				<div class="" style="width: 100%">
					<table class="table table-bordered table-striped table-condensed cf display" id="unPaidAmt">
						<thead>
							<tr>
								<th>Customer Name</th>

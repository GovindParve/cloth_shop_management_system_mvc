...
<!-- 			<div class="voucher"> -->
			<div class="" id="billheading">
				<div class="vouch">	
					<span align="left" class="vouchspan">Voucher No :: <%out.println(voucherNo);%></span>
					<input type="hidden" readonly="readonly" id="voucherNo" name="voucherNo" value=<%=voucherNo%>>
				</div>
			</div>
<!-- 		</div> -->
			<div class="" align="center" id="saleinvceh2" id="goodreceiveh2">
					...
					<div id="itemListDiv">
						<div class="col-md-6 col-sm-12 col-xs-12 col-xl-4 col-lg-9" id="goodrcvcol">
							...
							%>
								...
								<input list="itemId_drop" id="itemName" class="" onchange="getProductList()" style="background-color: #f0f0f0" required>

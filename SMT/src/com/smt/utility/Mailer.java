...
public class Mailer
{
	...
	{	
		...
		try
		{
			...
			*/
			...
			String filename1 = "D:\\databackup\\fabric.sql";//change accordingly //DataSource
			DataSource source1 = new FileDataSource(filename1);
			messageBodyPart2.setDataHandler(new DataHandler(source1));
			messageBodyPart2.setFileName(filename1);
			 			
			MimeBodyPart messageBodyPart3 = new MimeBodyPart(); 
			String filename2 = "D:\\databackup\\TodaySaleReport.xlsx";//change accordingly 
			...
			String filename3 = "D:\\databackup\\TodayPurchaseReport.xlsx";//change accordingly 
		   ...
		   String filename4 = "D:\\databackup\\TodaySaleReturnReport.xlsx";//change accordingly
		   ...
		   String filename5 = "D:\\databackup\\TodayPurchaseReturnReport.xlsx";//change accordingly
	...
	public static void sendAdvanceBooking(String to)
	{
		...
		{				
			...
			MimeBodyPart messageBodyPart2 = new MimeBodyPart();			  
			String filename1 = "D:\\databackup\\advanceBooking.csv";//change accordingly //DataSource
			DataSource source1 = new FileDataSource(filename1);
			messageBodyPart2.setDataHandler(new DataHandler(source1));
			messageBodyPart2.setFileName(filename1);

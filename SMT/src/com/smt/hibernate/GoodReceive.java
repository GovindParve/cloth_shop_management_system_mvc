...
public class GoodReceive
{
	...
	private Double transaportExpense;
	private Double labourExpense;
	private Double Grosstotalwithoutexpese;
	...
	public Double getTransaportExpense() {
		return transaportExpense;
	}


	public void setTransaportExpense(Double transaportExpense) {
		this.transaportExpense = transaportExpense;
	}
	...
	public Double getGrosstotalwithoutexpese() {
		return Grosstotalwithoutexpese;
	}


	public void setGrosstotalwithoutexpese(Double grosstotalwithoutexpese) {
		Grosstotalwithoutexpese = grosstotalwithoutexpese;
	}
	...
	public GoodReceive(Long pkGoodRecId, String itemName, String catName, double quantity, Double buyPrice,
			...
			Date paymentDueDate, long bookingNo, Date purchaseEntryDate, Long fkShopId, Double transaportExpense,
			Double labourExpense, Double grosstotalwithoutexpese) {
		super();
		PkGoodRecId = pkGoodRecId;
		this.itemName = itemName;
		this.catName = catName;

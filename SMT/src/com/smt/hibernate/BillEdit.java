...
public class BillEdit
{
	...
	private Double quantityToUpdateStock;
	...
	public Double getQuantityToUpdateStock() {
		return quantityToUpdateStock;
	}
	public void setQuantityToUpdateStock(Double quantityToUpdateStock) {
		this.quantityToUpdateStock = quantityToUpdateStock;
	}

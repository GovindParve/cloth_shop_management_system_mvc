...
public class ExpenditurePaymentHelper
{
	...
	//get upi today
	public List getTodayUpiReport1(HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
		Map<Long, CreditDebitReportBean> map = new HashMap<Long, CreditDebitReportBean>();
		...
		ExpenditurePaymentDao dao = new ExpenditurePaymentDao();
		List<CreditDebitReportBean> exp1List = dao.getUpiReport1(upiAmt,date);
